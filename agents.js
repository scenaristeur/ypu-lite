...
const systemPrompt = "Tu participes à une conversation entre plusieurs utilisateurs. Tu es là pour les aider à résoudre leurs problèmes."       
...
const onMessage = async function(m){
 if(m.role != "ai"){
    ...
    console.log(m)
    const response = await session.prompt("speaker:"+m.speaker+"\n"+"text:"+m.text);
